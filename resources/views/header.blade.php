	<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logo-cake.png" width="100px" alt=""></a>
				</div>
					...
					@if(Session::has('cart'))
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
									<a class="cart-item-delete" href="{{route('xoagiohang',$product['item']['id_product'])}}"><i class="fa fa-times"></i></a>
									<div class="media">
					...
					<ul class="l-inline ov">
						...
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
								...
								<li><a href="{{route('loaisanpham',$loai -> id)}}">{{$loai -> type_name}}</a></li>
								@endforeach
							</ul>
						</li>
